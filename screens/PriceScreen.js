...
const tabs = [
  { key: "Men", label: "Men", icon: require("../assets/menprice.jpg") },
  { key: "Women", label: "Women", icon: require("../assets/womenprice.webp") },
  { key: "kids", label: "Kids", icon: require("../assets/kidsprice.webp") },
  {
    key: "Household",
    label: "Households",
    icon: require("../assets/houseHoldsprice.webp"),
  },
];
